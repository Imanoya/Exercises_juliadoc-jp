...
なぜこれについてのすべての大騒ぎ？従来の例を考えてみましょう：2014年1月31日に1か月を追加します。
...
答えは何ですか？ Javascriptは[3月3日](http://www.markhneedham.com/blog/2009/01/07/javascript-add-a-month-to-a-date/)と表示されます(31日間を想定)。
...
どのようにそれを把握するのですか？私はカジノで古典的な7-7-7の賭けるゲームを考えるのが好きです。
...
祝日は完璧な例です。 ほとんどが「メモリアルデー= 5月の最後の月曜日」、または「感謝祭= 11月の第4木曜日」などの規則に従います。
